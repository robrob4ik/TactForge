...
namespace GPUInstancerPro.PrefabModule
{
    ...
    public class CustomGPUIRuntimePrototypeDefiner : MonoBehaviour
    {
        ...
        [ContextMenu("GPUI: Force Prototype Refresh")]
        public void ForcePrototypeRefresh()
        {
            GPUICoreAPI.RegenerateRenderers();
        }
    }
}
