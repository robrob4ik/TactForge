...
namespace OneBitRob.ECS
{
    ...
    public class WeaponProjectile : ProjectileBase
    {
        ...
        protected override bool ApplyOnHit(UnitBrain targetBrain, Vector3 point)
        {
            ...
            var rangedDef = _attackerBrain != null ? _attackerBrain.UnitDefinition?.weapon as RangedWeaponDefinition : null;
            if (rangedDef != null && rangedDef.impactFeedback != null) FeedbackService.TryPlay(rangedDef.impactFeedback, targetBrain.transform, point);
