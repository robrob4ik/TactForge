...
namespace OneBitRob.AI
{
    ...
    public partial class SetupUnitSystem : TaskProcessorSystem<SetupUnitComponent, SetupUnitTag>
    {
        protected override TaskStatus Execute(Entity e, UnitBrain brain)
        {
            ...
            float engage =
                isRanged
                    ? math.min(attackRangeBase * 0.6f, attackRangeBase - 1f)
            ...
            if (!em.HasComponent<BannerLeash>(e)) { em.AddComponentData(e, new BannerLeash { Radius = 99999f, Slack = 1.5f }); }
