...
namespace OneBitRob.EnigmaEngine
{
    ...
    [AddComponentMenu("Enigma Engine/Character/Health/Enigma Damage Resistance")]
    public class EnigmaDamageResistance : MonoBehaviour
    {
        public enum DamageModifierModes
        {
            Multiplier,
            Flat
        }

        public enum KnockbackModifierModes
        {
            Multiplier,
            Flat
        }
        ...
        [Title("Damage Resistance Settings")]
        ...
        [Tooltip("In TypedDamage mode, the type of damage this resistance will interact with")] [MMEnumCondition("DamageTypeMode", (int)DamageTypeModes.TypedDamage)]
        public EnigmaDamageType TypeResistance;
        ...
        [Tooltip("In flat mode, the amount of damage to subtract every time that type of damage is received")] [MMEnumCondition("DamageModifierMode", (int)DamageModifierModes.Flat)]
        ...
        [Tooltip("The values between which to clamp incoming damage")] [MMVector("Min", "Max")]
        ...
        [Tooltip("In flat mode, the amount of knockback to subtract every time that type of damage is received")] [MMEnumCondition("KnockbackModifierMode", (int)DamageModifierModes.Flat)]
        ...
        [Tooltip("The values between which to clamp incoming knockback magnitude")] [MMCondition("ClampKnockback", true)]
        ...
        public virtual float ProcessDamage(float damage, EnigmaDamageType type, bool damageApplied)
        {
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        public virtual Vector3 ProcessKnockback(Vector3 knockback, EnigmaDamageType type)
        {
            if (!this.gameObject.activeInHierarchy)
            {
                return knockback;
