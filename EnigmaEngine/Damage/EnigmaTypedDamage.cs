...
namespace OneBitRob.EnigmaEngine
{
    ...
    public class EnigmaTypedDamage
    {
        ...
        [Tooltip("When in forced character condition mode, the condition to which to swap")] [MMCondition("ForceCharacterCondition", true)]
        public EnigmaCharacterStates.CharacterConditions ForcedCondition;

        /// when in forced character condition mode, whether or not to disable gravity
        [Tooltip("When in forced character condition mode, whether or not to disable gravity")] [MMCondition("ForceCharacterCondition", true)]
        public bool DisableGravity = false;

        /// when in forced character condition mode, whether or not to reset controller forces
        [Tooltip("When in forced character condition mode, whether or not to reset controller forces")] [MMCondition("ForceCharacterCondition", true)]
        ...
        [Tooltip("When in forced character condition mode, the duration of the effect, after which condition will be reverted")] [MMCondition("ForceCharacterCondition", true)]
        ...
        [Tooltip("The movement multiplier to apply when ApplyMovementMultiplier is true")] [MMCondition("ApplyMovementMultiplier", true)]
        public float MovementMultiplier = 0.5f;

        /// the duration of the movement multiplier, if ApplyMovementMultiplier is true
        [Tooltip("The duration of the movement multiplier, if ApplyMovementMultiplier is true")] [MMCondition("ApplyMovementMultiplier", true)]
