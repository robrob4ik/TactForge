...
namespace OneBitRob.EnigmaEngine
{
    ...
    [AddComponentMenu("Enigma Engine/Weapons/Enigma Weapon Ammo")]
    public class EnigmaWeaponAmmo : MonoBehaviour,
        MMEventListener<MMStateChangeEvent<MoreMountains.TopDownEngine.Weapon.WeaponStates>>,
        MMEventListener<MMInventoryEvent>, MMEventListener<MMGameEvent>
    {
        ...
        {
            _weapon = GetComponent<EnigmaWeapon>();
            Inventory[] inventories = FindObjectsByType<Inventory>(FindObjectsSortMode.None);
            foreach (Inventory inventory in inventories)
            {
                EnigmaCharacterInventory characterInventory = _weapon.Owner.FindAbility<EnigmaCharacterInventory>();
